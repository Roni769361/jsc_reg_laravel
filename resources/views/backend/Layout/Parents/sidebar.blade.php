          ...
          <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
              <ul id="sidebarnav">
                  ...
                  <li class="sidebar-item">
                      <a class="sidebar-link primary-hover-bg justify-content-between"
                          href="{{url('admin/dashboard/bulk/student')}}" aria-expanded="false">
                          <div class="d-flex align-items-center gap-6">
                              <span class="d-flex">
                                  <iconify-icon icon="solar:screencast-2-line-duotone" class=""></iconify-icon>
                              </span>
                              <span class="hide-menu">Bulk Input</span>
                          </div>
                      </a>
                  </li>
                  <li class="sidebar-item">
                      <a class="sidebar-link primary-hover-bg justify-content-between"
                          href="{{url('admin/dashboard/bulk/student/list')}}" aria-expanded="false">
                          <div class="d-flex align-items-center gap-6">
                              <span class="d-flex">
                                  <iconify-icon icon="solar:screencast-2-line-duotone" class=""></iconify-icon>
                              </span>
                  ...
                  <li class="sidebar-item">
                      <a class="sidebar-link primary-hover-bg justify-content-between"
                          href="{{url('admin/dashboard/basic')}}" aria-expanded="false">
                          <div class="d-flex align-items-center gap-6">
                              <span class="d-flex">
                                  <iconify-icon icon="solar:screencast-2-line-duotone" class=""></iconify-icon>
                              </span>
              ...
              <div
                  ...
                  <div class="unlimited-access-img">
                      <img src="{{asset('backend')}}/assets/images/backgrounds/sidebar-buynow-bg.png" alt="" class="img-fluid">
                  </div>
              </div>
          </nav>
